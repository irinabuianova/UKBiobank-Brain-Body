...
modality_folders = {
    ...
    'Schaefer7n500p_Tian_S4': '31026_Schaefer7n500p_Tian_S4'
}
...
dwi_modalities = [
    ...
    'Schaefer7n500p_Tian_S4_FA_i2',
    'Schaefer7n500p_Tian_S4_Length_i2',
    'Schaefer7n500p_Tian_S4_SIFT2_FBC_i2',
    'Schaefer7n500p_Tian_S4_Streamline_Count_i2'
]
...
def deconfound_dwi(modality, fold):
    ...
    try:
        ...
        features = load_data_with_memory_efficiency(find_modality_file(modality))
        confounds = load_data_with_memory_efficiency(
            os.path.join(BASE_PATH, 'brain/data/dwMRI/dwi_conf.csv')
        )
