...
targets_train = pd.read_csv(os.path.join(suppl_path, f'{modalities[modality]}_train_feat_targ_conf_fold_{fold}.csv'), usecols = ['eid', 'g'])
targets_test = pd.read_csv(os.path.join(suppl_path, f'{modalities[modality]}_test_feat_targ_conf_fold_{fold}.csv'), usecols = ['eid', 'g'])

targets_train.to_csv(os.path.join(suppl_path, f'{modalities[modality]}_train_targets_fold_{fold}.csv'), index=False)
targets_test.to_csv(os.path.join(suppl_path, f'{modalities[modality]}_test_targets_fold_{fold}.csv'), index=False)
